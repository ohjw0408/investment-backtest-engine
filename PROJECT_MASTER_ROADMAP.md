...
Current blocker: **없음.** (2026-06-13 갱신) P0~P4 전부 마감 + D4 거래수수료 전탭(계좌별·은퇴·배당) + **A4 종목상세(캔들차트·시간봉·타입별 지표)** 완료. **다음 = PHASE4 잔여(D1 TDF·D2 연금통합·C1 watchlist·C2 자산군비교·B4 거래트래킹) — 오너 결정.** (B2-a 홈토글=오너 skip)
