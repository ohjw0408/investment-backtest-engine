...
SERIES = [
    ...
    # 미국 섹터·스타일·기타 지수
    _yf("SOX", "^SOX", "US", "필라델피아 반도체지수(SOX)"),
    _yf("FANG", "^NYFANG", "US", "NYSE FANG+ (빅테크)"),
    _yf("DJT", "^DJT", "US", "다우존스 운송지수"),
    _yf("DJU", "^DJU", "US", "다우존스 유틸리티지수"),
    _yf("NYSE", "^NYA", "US", "NYSE 종합지수"),
    _yf("SP100", "^OEX", "US", "S&P 100"),
    _yf("SP400", "^MID", "US", "S&P 미드캡 400"),
    _yf("SP600", "^SP600", "US", "S&P 스몰캡 600"),
    _yf("RUSSELL1000", "^RUI", "US", "러셀 1000"),
    _yf("RUSSELL3000", "^RUA", "US", "러셀 3000"),
    _yf("WILSHIRE5000", "^W5000", "US", "윌셔 5000(전체시장)"),
    _yf("DXY", "DX-Y.NYB", "US", "달러인덱스(DXY)"),
    # 한국
    _yf("KOSPI200", "^KS200", "KR", "코스피 200"),
    # 글로벌 추가
    _yf("STOXX600", "^STOXX", "GL", "STOXX 유럽 600"),
    _yf("CAC40", "^FCHI", "GL", "CAC 40 (프랑스)"),
    _yf("IBEX", "^IBEX", "GL", "IBEX 35 (스페인)"),
    _yf("SMI", "^SSMI", "GL", "SMI (스위스)"),
    _yf("ASX200", "^AXJO", "GL", "ASX 200 (호주)"),
    _yf("TSX", "^GSPTSE", "GL", "S&P/TSX (캐나다)"),
    _yf("BOVESPA", "^BVSP", "GL", "보베스파 (브라질)"),
    _yf("MEXICO", "^MXX", "GL", "IPC (멕시코)"),
...
DESCRIPTIONS = {
    ...
    "IDX_SOX": "필라델피아 반도체지수(SOX). 미국 상장 주요 반도체 기업 30종으로, 반도체 업황의 대표 바로미터입니다.",
    "IDX_FANG": "NYSE FANG+. 메타·애플·아마존·넷플릭스·구글 등 대형 기술주를 모은 지수입니다.",
    "IDX_DJT": "다우존스 운송지수. 항공·철도·물류 등 운송주로, 실물경기 신호로 여겨집니다.",
    "IDX_DJU": "다우존스 유틸리티지수. 전기·가스 등 유틸리티주로 금리에 민감한 방어주 지표입니다.",
    "IDX_NYSE": "NYSE 종합지수. 뉴욕증권거래소 상장 전 종목을 포괄하는 광범위 지수입니다.",
    "IDX_SP100": "S&P 100. S&P500 중 초대형 우량주 100개로 구성됩니다.",
    "IDX_SP400": "S&P 미드캡 400. 미국 중형주 대표 지수입니다.",
    "IDX_SP600": "S&P 스몰캡 600. 미국 소형주 대표 지수입니다.",
    "IDX_RUSSELL1000": "러셀 1000. 미국 대형주 1000개 지수입니다.",
    "IDX_RUSSELL3000": "러셀 3000. 미국 상장 사실상 전체(대·중·소형) 시장 지수입니다.",
    "IDX_WILSHIRE5000": "윌셔 5000. 미국 전체 주식시장을 포괄하는 총시장 지수입니다.",
    "IDX_DXY": "달러인덱스(DXY). 유로·엔 등 6개 주요통화 대비 달러 가치로, 오르면 달러 강세입니다.",
    "IDX_KOSPI200": "코스피 200. 코스피 대형 우량주 200개로 파생상품·ETF의 기초가 됩니다.",
    "IDX_STOXX600": "STOXX 유럽 600. 유럽 17개국 대형·중형·소형주 600개를 포괄합니다.",
    "IDX_CAC40": "CAC 40. 프랑스 파리증시 대표 지수입니다.",
    "IDX_IBEX": "IBEX 35. 스페인 마드리드증시 대표 지수입니다.",
    "IDX_SMI": "SMI. 스위스 증시 대표 지수입니다.",
    "IDX_ASX200": "S&P/ASX 200. 호주 증시 대표 지수입니다.",
    "IDX_TSX": "S&P/TSX 종합. 캐나다 토론토증시 대표 지수입니다.",
    "IDX_BOVESPA": "보베스파(Ibovespa). 브라질 상파울루증시 대표 지수입니다.",
    "IDX_MEXICO": "S&P/BMV IPC. 멕시코 증시 대표 지수입니다.",
