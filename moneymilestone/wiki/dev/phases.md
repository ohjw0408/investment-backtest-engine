...
| Phase 2c | 배당 역산 Runner 전환 + `sim/tax_engine.py` 삭제 | Gate 2c | ✅ 완료 | Gate 2c PASSED 2026-05-28 (SCHD/TIGER 수렴 확인) |
| Phase 2d | 은퇴 인출 세금 주입 (`WithdrawalAnalyzer`) | Gate 2d | ✅ 완료 | Gate 2d PASSED 5/5 (2026-05-28) |
| Phase 2e | 금융소득 종합과세 경고 + 분할매도 절세 패널 | — | ✅ 완료 | 분할매도 패널 + 세후이익 표시 (2026-05-29) |
...
| Phase 1 | 즉각적 수정: `_fetch_fred()` 구현, KOSDAQ150→KQ150 매핑, DJUSDIV100 보강, PriceLoader 실패 처리 수정, 인덱스 충분성 검사 추가 | ✅ 완료 (2026-05-28) |
...
**완료 (2026-05-28)**: DJUSDIV_PROXY 체인 구축, KQ150 매핑, _fetch_fred() 수정, PriceLoader 백필 실패 처리, div_stats 미완료 연도 제외. SCHD vs TIGER 수렴 확인.
