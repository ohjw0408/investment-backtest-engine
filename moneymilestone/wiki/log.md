...
- ⚠️ **만기매칭형 듀레이션 2.0은 여전히 과대.** 실데이터 std가 함의하는 듀레이션은 0.2~0.9인데
  백필은 2.0으로 30년 역사를 만든다. 손상은 아니지만 "2026-04에 만기가 오는 펀드의 1995년"이
  일반 회사채 펀드처럼 움직인다. 고치면 백테 결과가 바뀌므로 **오너 판단 대기**(2026-08-03 항목과 동일 건).
