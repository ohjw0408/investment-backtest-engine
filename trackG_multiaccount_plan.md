...
### 미흡 항목 (2026-05-31 현재 — 다음 세션 선결)
- **L4 구멍 4개**(현 4케이스는 정상경로+일부엣지만): ④정책cap ⑤leftover>0 ⑥연금+IRP합산 + **L4-tax**(세금ON 라우팅).
- **L5c(2-4) 미정의였음 → 위 표에 신규 추가.** 구현 시 공유세션 멀티배선 선행.
- `assert_invariants` 공통 헬퍼 미존재 → 신설 후 전 L케이스 적용.
