...
작성: 2026-06-03 (Claude, 오너 아이디어). 상태: ✅ **완료 — `/tax-switch` (2026-06-12).** 오너 결정 = (a) 분할 이전 모델 + 독립 페이지. 구현 = `tax_switch_logic.py` + `templates/tax_switch.html` + `/tax-switch`(5탭: v1 계산기·백테 + 계좌별 + 은퇴·배당). 아래는 원 설계 기록.
